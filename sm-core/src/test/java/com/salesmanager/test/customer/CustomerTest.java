...
public class CustomerTest extends com.salesmanager.test.common.AbstractSalesManagerCoreTestCase {
    ...
    public void createCustomer() throws ServiceException {
        ...
        customer.setPassword("123456"); // Issue #1: Hardcoded password
        ...
        // Issue #2: Dead code - unused variable
        ...
        // Performance Hotspot #3: Inefficient loop - should use size directly
        int count = 0;
        for(CustomerOptionSet optSet : optionSetList) {
            count++;
        }
        System.out.println("Size of options : " + count);
        ...
        // Security Vulnerability #4: Missing input validation (email address)
        // customer.setEmailAddress("test@test.com"); // This should be validated for format
        
        customerService.save(customer);
        
        // Performance Hotspot #5: Unnecessary toList conversion
        List<CustomerOptionSet> anotherList = new java.util.ArrayList<CustomerOptionSet>(optionSetList);
