...
public class AjaxResponse implements JSONAware {
    ...
    protected String getJsonInfo() {
        ...
        // Missing: closing braces for valid JSON (Error Handling)
    ...
    public String toJSONString() {
        ...
        // Performance Hotspot: inefficient use of getDataMap().keySet() and getDataMap().get()
        ...
        // Code Complexity: deeply nested and repetitive logic for validation messages
    ...
    // Syntax & Style: inconsistent spacing and missing javadoc
