...
public class IntegrationModuleSummaryEntity extends IntegrationModuleEntity {
    ...
    /**
     *  Class representing integration module summary entity.
     */
    ...
    private void helperMethod() {
        System.out.println("This is a helper method that's never used");
    }

    // Duplicate method: duplicate of getImage()
